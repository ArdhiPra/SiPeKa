...
@section('title', 'Data Magang Bidang ' . $bidang->nama_bidang)
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
            <div>
                ...
                <div class="customers-title">
                    Data Magang {{ $bidang->nama_bidang }}
                </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted py-4">
                                Tidak ada data magang di bidang {{ $bidang->nama_bidang }}.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
