    ...
    <div class="row align-items-start">
        ...
        <div class="col-lg-6 text-left-adjust">
            ...
            <div class="my-3">
                ...
                <button id="btn-visi" class="btn btn-light rounded-pill px-4 me-2"
        ...
        <div class="col-lg-6 text-center mt-4 mt-lg-0 image-shift-right">
            <div class="image-sticky">
                <img src="{{ asset('assets/ikon kominfo.jpg') }}"
                     class="img-fluid illustration-img" alt="Kominfo">
            </div>
        </div>
...
<footer class="custom-footer mt-5">
    <div class="container-fluid px-5">
        ...
        {{-- SOCIAL MEDIA --}}
        <div class="row py-4" id="kontak">
            <div class="col text-center">

                <a href="https://www.youtube.com/denpasarkota" target="_blank" class="social-icon">
                ...
                <a href="https://www.instagram.com/denpasarkota" target="_blank" class="social-icon">
                    <i class="fab fa-instagram"></i>
                </a>

                <a href="https://www.facebook.com/denpasarkota" target="_blank" class="social-icon">
                    <i class="fab fa-facebook"></i>
                </a>

                <a href="https://denpasarkota.go.id/home" target="_blank" class="social-icon">
        ...
        <div class="row align-items-center py-3 small">
            <div class="col-md-4 fw-semibold">
                Copyright &copy; 2025 - 2026 APaR | SiPeKa
            </div>
